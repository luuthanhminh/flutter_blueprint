...
// in fl_blueprint/test/components_viewmodel_test.dart.
...
import 'package:fl_blueprint/domain/entities/component.dart' as _i7;
import 'package:fl_blueprint/domain/usecases/fetch_components_usecase.dart'
    as _i6;
...
class MockFetchComponentsUseCase extends _i1.Mock
  ...
  @override
  _i3.Future<List<_i7.Component>> perform({Object? param}) =>
      (super.noSuchMethod(Invocation.method(#perform, [], {#param: param}),
              returnValue: Future<List<_i7.Component>>.value(<_i7.Component>[]))
          as _i3.Future<List<_i7.Component>>);
}
